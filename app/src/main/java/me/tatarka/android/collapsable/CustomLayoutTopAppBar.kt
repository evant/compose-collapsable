    ...
    Layout(
        ...
        content = {
            NavigateBackButton(
                ...
                modifier = Modifier.layoutId(CLLayoutId.Navigation)
            )
            ...
            Text(
                ...
                modifier = Modifier
                    ...
                    .layoutId(CLLayoutId.Title)
            )

            Button(onClick = {}, modifier = Modifier.layoutId(CLLayoutId.Action)) {
                Text("Action")
            }
        },
        measurePolicy = { measurables, constraints ->
            val navigationPlaceable = measurables.first { it.layoutId == CLLayoutId.Navigation }
                .measure(
                    Constraints(
            ...
            val titlePlaceable = measurables.first { it.layoutId == CLLayoutId.Title }
                .measure(constraints.copy(minHeight = 0))

            val actionPlaceable = measurables.first { it.layoutId == CLLayoutId.Action }
                .measure(
                    Constraints(
                        maxWidth = constraints.maxWidth,
                        maxHeight = constraints.maxHeight
